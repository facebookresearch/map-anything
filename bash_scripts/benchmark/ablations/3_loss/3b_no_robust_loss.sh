...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/morphcloud/training_ablations/3b_no_robust_loss/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/morphcloud/benchmarking_ablations/dense_'"${num_views}"'_view/3b_no_robust_loss'
