...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/morphcloud/training_ablations/2a_gat/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/morphcloud/benchmarking_ablations/dense_'"${num_views}"'_view/2a_gat'
