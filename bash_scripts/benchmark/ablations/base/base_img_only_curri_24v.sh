...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/morphcloud/training_ablations/base_mapa_img_only_curri_24v/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/morphcloud/benchmarking_ablations/dense_'"${num_views}"'_view/base_img_only_curri_24v'
