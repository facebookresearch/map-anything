...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/morphcloud/training_ablations/a1e_campm_pose_conf_mask_scale/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/morphcloud/benchmarking_ablations/dense_'"${num_views}"'_view/a1e_mvs_campm_pose_conf_mask_scale'
