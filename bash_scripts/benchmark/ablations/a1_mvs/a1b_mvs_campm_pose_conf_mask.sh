...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/morphcloud/training_ablations/a1b_campm_pose_conf_mask/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/morphcloud/benchmarking_ablations/dense_'"${num_views}"'_view/a1b_mvs_campm_pose_conf_mask'
