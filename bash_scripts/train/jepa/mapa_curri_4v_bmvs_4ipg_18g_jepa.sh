...
module load cuda/12.4 nccl/2.18.3-cuda.12.4
...
torchrun --nproc_per_node ${NUM_GPUS} --nnodes ${NUM_NODES} --node_rank ${NODE_RANK} \
    ...
    train_params.jepa=true \
    hydra.run.dir='${root_experiments_dir}/mapanything/training/mapa_curri_4v_bmvs_4ipg_18g_jepa'
